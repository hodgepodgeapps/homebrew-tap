class BezelItBeta < Formula
  desc "Add bezels to Apple device screenshots and videos"
  homepage "https://www.hodgepodgeapps.com/bezel-it/"
  url "https://github.com/hodgepodgeapps/bezel-it-cli/releases/download/v2.6.0-beta.1/bezelit-macos.zip"
  ...
  def install
    bin.install "BezelItCommandLine" => "bezelit-beta"
  end
  ...
  test do
    assert_match "bezelit", shell_output("#{bin}/bezelit-beta --help")
  end
end
